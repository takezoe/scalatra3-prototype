...
object views {
   ...
   * Render a text field.
   */
  def text(name: String, attributes: (String, String)*)(implicit request: ScalatraRequest): String = {
   ...
   */
  def password(name: String, attributes: (String, String)*)(implicit request: ScalatraRequest): String = {
   ...
   * Render a textarea.
   */
  def textarea(name: String, attributes: (String, String)*)(implicit request: ScalatraRequest): String = {
   ...
   * Render a checkbox.
   */
  def checkbox(name: String, value: String, attributes: (String, String)*)(implicit request: ScalatraRequest): String = {
   ...
   */
  def radio(name: String, value: String, attributes: (String, String)*)(implicit request: ScalatraRequest): String = {
   ...
   * Render a select box.
   */
  def select(name: String, values: Seq[(String, String)], multiple: Boolean, attributes: (String, String)*)(implicit request: ScalatraRequest): String = {
  ...
  private def param(name: String)(implicit request: ScalatraRequest): String = {
